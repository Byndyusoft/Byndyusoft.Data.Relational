...
namespace Byndyusoft.Data.Relational
{
    ...
    public interface IDbSessionFactory
    {
        ...
        /// <summary>
        ///     Returns a new instance of the commitable database session's class that implements the <see cref="ICommittableDbSession"/> interface with specified <see cref="IsolationLevel"/>.
        /// </summary>
