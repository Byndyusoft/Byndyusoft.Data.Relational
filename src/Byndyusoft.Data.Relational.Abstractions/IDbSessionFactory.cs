...
namespace Byndyusoft.Data.Relational
{
    ...
    public interface IDbSessionFactory
    {
        ...
        /// <summary>
        ///     Returns a new instance of the database session's class that implements the <see cref="IDbSession" /> interface with specified name.
        /// </summary>
        ...
        /// <summary>
        ///     Returns a new instance of the commitable database session's class that implements the <see cref="ICommittableDbSession" /> interface.
        /// </summary>
        /// <param name="cancellationToken">
        ///     An optional token to cancel the asynchronous operation. The default value is
        ///     <see cref="CancellationToken.None" />.
        ...
        /// <summary>
        ///     Returns a new instance of the commitable database session's class that implements the <see cref="ICommittableDbSession" /> interface with specified name.
        /// </summary>
        /// <param name="name">The name of the <see cref="IDbSession"/>.</param>
        /// <param name="cancellationToken">
        ///     An optional token to cancel the asynchronous operation. The default value is
        ...
        /// </param>
        /// <returns>A new instance of <see cref="ICommittableDbSession" />.</returns>
        Task<ICommittableDbSession> CreateCommittableSessionAsync(string name, CancellationToken cancellationToken = default);
