...
namespace Byndyusoft.Data.Relational
{
    ...
    public static class DbSessionQueryObjectExtensions
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await session.QueryAsync<T>(queryObject.Sql, queryObject.Params, commandTimeout,
                commandType, cancellationToken).ConfigureAwait(false);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await session
                .QuerySingleAsync<T>(queryObject.Sql, queryObject.Params, commandTimeout, commandType,
                    cancellationToken).ConfigureAwait(false);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await session.QuerySingleOrDefaultAsync<T>(queryObject.Sql, queryObject.Params, commandTimeout,
                commandType, cancellationToken).ConfigureAwait(false);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await session
                .QueryFirstAsync<T>(queryObject.Sql, queryObject.Params, commandTimeout, commandType,
                    cancellationToken).ConfigureAwait(false);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await session.QueryFirstOrDefaultAsync<T>(queryObject.Sql, queryObject.Params, commandTimeout,
                commandType, cancellationToken).ConfigureAwait(false);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await session.ExecuteScalarAsync<T>(queryObject.Sql, queryObject.Params, commandTimeout,
                commandType,
                cancellationToken).ConfigureAwait(false);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return session.Query<T>(queryObject.Sql, queryObject.Params, commandTimeout, commandType,
                cancellationToken);
        }
